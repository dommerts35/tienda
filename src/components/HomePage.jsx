    ...
    const categories = [
        {
            id: 'regalos',
            name: 'Regalos',
            description: 'Encuentra el detalle perfecto para ocasiones especiales',
            icon: Gift,
        ...
        },
        {
            id: 'ropa',
            name: 'Ropa',
            description: 'Moda y estilo para tu día a día',
            icon: Shirt,
        ...
        },
        {
            ...
            description: 'Asesoría profesional y confiable',
            icon: Scale,
        ...
        <div className="homepage">
            ...
            <section id="categories" className="categories-section">
                <div className="container">
                    ...
                    <p className="section-subtitle">Descubre todo lo que tenemos para ofrecerte</p>
                                ...
                                >
                                    <div className="category-image">
                                        ...
                                        <div className="category-overlay">
                                            <IconComponent size={48} className="category-icon" />
                                        </div>
                                    </div>
                    ...
                    <div className="view-all-categories">
                        <Link to="/catalogo" className="view-all-btn">
                            <Grid size={20} style={{ marginRight: '8px' }} />
